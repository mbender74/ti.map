...
MKMapRect MKMapRectForCoordinateRegion(MKCoordinateRegion region)
{
  ...
  CLLocationCoordinate2D topLeft = CLLocationCoordinate2DMake(center.latitude + span.latitudeDelta / 2.0,
      center.longitude - span.longitudeDelta / 2.0);
  CLLocationCoordinate2D bottomRight = CLLocationCoordinate2DMake(center.latitude - span.latitudeDelta / 2.0,
      center.longitude + span.longitudeDelta / 2.0);
